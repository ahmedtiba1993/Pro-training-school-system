...
// @ts-ignore
import { ApiResponseListTrainingSessionResponse } from '../model/api-response-list-training-session-response';
// @ts-ignore
...
export class TrainingSessionControllerService extends BaseService implements TrainingSessionControllerServiceInterface {
     ...
     * @param options additional options
     */
    public getInProgressSessions(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<ApiResponseListTrainingSessionResponse>;
    public getInProgressSessions(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<ApiResponseListTrainingSessionResponse>>;
    public getInProgressSessions(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<ApiResponseListTrainingSessionResponse>>;
    public getInProgressSessions(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/api/v1/training-sessions/in-progress`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<ApiResponseListTrainingSessionResponse>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
     ...
     * @param options additional options
     */
    public getSessionsByLevelAndSpecialty(levelId: number, specialtyId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<ApiResponseListTrainingSessionResponse>;
    public getSessionsByLevelAndSpecialty(levelId: number, specialtyId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<ApiResponseListTrainingSessionResponse>>;
    public getSessionsByLevelAndSpecialty(levelId: number, specialtyId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<ApiResponseListTrainingSessionResponse>>;
    public getSessionsByLevelAndSpecialty(levelId: number, specialtyId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (levelId === null || levelId === undefined) {
            throw new Error('Required parameter levelId was null or undefined when calling getSessionsByLevelAndSpecialty.');
        }
        if (specialtyId === null || specialtyId === undefined) {
            throw new Error('Required parameter specialtyId was null or undefined when calling getSessionsByLevelAndSpecialty.');
        }
        ...
        let localVarPath = `/api/v1/training-sessions/level/${this.configuration.encodeParam({name: "levelId", value: levelId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64"})}/specialty/${this.configuration.encodeParam({name: "specialtyId", value: specialtyId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64"})}`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<ApiResponseListTrainingSessionResponse>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
