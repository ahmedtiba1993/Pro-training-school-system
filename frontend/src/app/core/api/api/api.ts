...
export const APIS = [AcademicYearControllerService, AuthControllerService, ExamSessionControllerService, LevelControllerService, SpecialtyControllerService, TermControllerService];
